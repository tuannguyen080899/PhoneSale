...
<div style="margin-top: 20px">
	...
	<div class="row">
		...
		<div class="col-sm-2">
			<p style="color: #DF7401"><%=gio.getThanhtien()%>
				VND
			</p>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-sm-4">
			<p style="color: #DF7401"><%=(tk == null) ? "" : daokhuvuc.getKhuvucByMakhuvuc(tk.getMakhuvuc()).getTenkhuvuc()%>
			</p>
		</div>
	</div>
	<div class="row">
	...
	<div class="row">
		...
		<div class="col-sm-4">
			<p style="color: #DF7401"><%=(tk == null) ? "" : daogio.totaltienvonGiohang(x)%>
				VND
			</p>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-sm-4">
			<p style="color: #DF7401"><%=(tk == null) ? "" : daogio.totalGiohang(x)%>
				VND
			</p>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-sm-4">
			<p style="color: #DF7401"><%=(tk == null) ? "" : (daogio.totalGiohang(x)-daogio.totaltienvonGiohang(x))%>
				VND
			</p>
		</div>
	</div>
